...
# # Relative import for your text preprocessors
...
#         try:
#             print("TTS: Loading Keras TTS model...")
...
#             }
#             # Adjust model path based on new structure
#             self.best_model = tf.keras.models.load_model(
#                 os.path.join(os.path.dirname(__file__), "model/1best_model_cnn_r_EarlyStopping.keras"),
#                 compile=False,
#                 custom_objects=custom_objects
#             )
#             print("TTS: Keras TTS model loaded.")

#             print("TTS: Loading G2P model...")
#             # Adjust model path for G2P
#             self.g2p = G2PConverter("model/1/3model_cnn.keras")
            
#             print("TTS: G2P model loaded.")

#             print("TTS: Initializing TextNormalizer...")
#             self.normalizer = TextNormalizer()
#             print("TTS: TextNormalizer initialized.")

#             print("TTS: Loading mel mean/std...")
#             # Adjust path for mean/std
#             mean_std_path = os.path.join(
#                 os.path.dirname(__file__),
#                 "dataset/acoustic_dataset(9f_eos_notduration)/mel_mean_std.npy"
#             )
...
#         # Ensure log_mel is a 2D array (n_mels, time_steps)
#         # Your model output `predicted_mel` is likely (time_steps, n_mels), so transpose needed.
